...
type BeforeTurnRequest struct {
	...
	ConversationItems []sdkmemory.ResponseItem `json:"conversation_items"`
	CurrentInputStart int                      `json:"current_input_start"`
	CurrentInputCount int                      `json:"current_input_count"`
