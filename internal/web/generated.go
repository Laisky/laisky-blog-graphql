...
func (ec *executionContext) unmarshalInputNewBlogPost(ctx context.Context, obj interface{}) (global.NewBlogPost, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "type":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("type"))
			it.Type, err = ec.unmarshalOBlogPostType2ᚖgithubᚗcomᚋLaiskyᚋlaiskyᚑblogᚑgraphqlᚋinternalᚋglobalᚐBlogPostType(ctx, v)
			if err != nil {
				return it, err
			}
		case "category":
...
func (ec *executionContext) unmarshalInputSort(ctx context.Context, obj interface{}) (global.Sort, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "order":
			...
			it.Order, err = ec.unmarshalNSortOrder2githubᚗcomᚋLaiskyᚋlaiskyᚑblogᚑgraphqlᚋinternalᚋglobalᚐSortOrder(ctx, v)
			if err != nil {
				return it, err
			}
		}
