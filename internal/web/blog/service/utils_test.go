...
func TestExtractMenu(t *testing.T) {
	...
	expect := `<nav id="post-menu" class="h-100 flex-column align-items-stretch pe-4 border-end"><nav class="nav nav-pills flex-column"><a class="nav-link" href="#abc">abc def</a><nav class="nav nav-pills flex-column"><a class="nav-link ms-3 my-1" href="#lev 3">333</a></nav></nav></nav>`
	if cnt != expect {
		t.Errorf("got: `%v`", cnt)
		t.Fatalf("expect: `%v`", expect)
	}
