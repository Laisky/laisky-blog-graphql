        ...
        <div className="space-y-12">
            ...
            <section className="space-y-4">
                ...
                <p className="max-w-3xl text-lg text-muted-foreground">
                    A unified interface for AI agents to interact with external tools and data. This
                    workspace provides management consoles and documentation for the available
                    capabilities.
                </p>
