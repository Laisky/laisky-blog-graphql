    ...
    <div className="space-y-8">
      <section className="space-y-4">
        ...
        <p className="max-w-2xl text-lg text-muted-foreground">
          Review pending MCP questions routed to your bearer token, send human
          answers, and browse the recent history. The HTTP API remains available
          under <code>/tools/ask_user/api</code> and respects the configured
          public base path.
        </p>
      </section>
      ...
      <Card className="border border-border/60 bg-card shadow-sm">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Enter the bearer token shared with your AI agent. The token is
            stored locally and never sent elsewhere.
          </p>
        </CardHeader>
