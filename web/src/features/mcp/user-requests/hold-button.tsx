 ...
 */
export function HoldButton({ isActive, isWaiting, remainingSecs, onActivate, onRelease, disabled, className }: HoldButtonProps) {
  ...
  return (
    <Button
      ...
      className={cn(isActive && 'bg-amber-600 hover:bg-amber-700 text-white', className)}
    >
      {isActive ? (
        <>
