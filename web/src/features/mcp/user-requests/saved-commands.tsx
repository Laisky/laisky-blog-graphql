        ...
        <Card className="border border-border/60 bg-card shadow-sm">
            <CardHeader className="pb-3">
                ...
                <p className="text-sm text-muted-foreground">
                    Store frequently used directives for quick access. Click any saved command to
                    load it into the editor. Commands are synced across all your devices.
                </p>
            </CardHeader>
            ...
            {isExpanded && (
                <CardContent className="space-y-4">
                    ...
                    {!apiKey ? (
                        ...
                        <div className="rounded-lg border border-dashed bg-muted/50 px-4 py-6 text-center text-sm text-muted-foreground">
                            No saved commands yet. Write a directive above and click &quot;Save
                            current&quot; to create your first template.
                        </div>
                    ) : (
